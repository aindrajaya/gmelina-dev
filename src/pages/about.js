          ...
          <div className="xl:text-lg text-base   font-medium">
            ...
            <div className="flex md:gap-8 md:flex-row flex-col w-full items-center">
              ...
              <div className="flex-grow ml-auto ">
                <Fade bottom>
                  <p>
                    This is the E-Commerce that sell any Fish Sed tempor fringilla scelerisque. Phasellus maximus suscipit volutpat. Morbi aliquet tristique dui sit amet finibus. Pellentesque nec ipsum porta nibh rutrum cursus. Vivamus accumsan lorem nec tellus posuere, at vestibulum mi imperdiet. Etiam a quam dictum, mattis orci vulputate, rutrum ligula. Donec ut vulputate est, semper tristique sapien.
                    ...
                    <span className="font-semibold text-blue-light underline mx-1">
                      <Link href="https://gmelina-barn.com">
                        Gmelina Barn
                      </Link>
                    </span>
